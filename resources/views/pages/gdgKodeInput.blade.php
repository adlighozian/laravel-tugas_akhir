            ...
            @if (session()->has('error'))
                <div class="w-full fixed top-[65px] left-0 flex items-center justify-center" role="alert">
                    <div
                        ...
                        <p>data tidak dapat dihapus, karena masih terdapat barang yang menggunakan id ini.</p>
                    </div>
                </div>
            @endif --}}
            {{-- ALERT END --}}
                        ...
                        <tbody class="text-black bg-white">
                            @foreach ($datakode as $datas)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/gdginputkode/delete/{{ $datas->id }}">delete</a>
                                        {{-- <button class="btn btn-danger flex items-center" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal">Delete {{ $datas->id }}</button> --}}
                                    </td>
                                </tr>
                                @php
                                    $count++;
                    ...
                    <div class="w-[387px] h-[333px] bg-white p-8 flex flex-col items-center justify-between rounded-xl">
                        ...
                        <div class="grid gap-4 grid-cols-2">
                            ...
                            <a href="/gdginputkode/delete/{{ $datas->id }}">
                                <button type="button" class="btn cursor-pointer bg-red-700 text-white w-[80px]">Ya</button>
                            </a>
                        </div>
                    </div>
                </div>
