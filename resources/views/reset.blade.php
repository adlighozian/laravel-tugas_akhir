...
<body>
    <div class="w-full h-[100vh] flex">
        ...
        <div class="sm:w-[700px] w-full h-full flex justify-center px-[30px] bg-warnasatu flex-col">
            ...
            @endif
            {{-- FORM START --}}
            <form action="/action_reset" method="post" class="w-full">
                @csrf
                <div class="mb-3">
                    <label for="inputEmail" class="mb-1">Email</label>
                    <input readonly type="text" id="email" class="form-control rounded-2xl h-[48px] border-0"
                        placeholder="Masukan email" name="email" required autofocus value="{{ $email }}">
                </div>
                <div class="mb-8">
